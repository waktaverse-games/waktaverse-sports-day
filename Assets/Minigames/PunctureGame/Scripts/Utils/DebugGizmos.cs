...
namespace GameHeaven.PunctureGame.Utils
{
    public class DebugGizmos : MonoBehaviour
    {
        ...
        [SerializeField, ShowIf(nameof(isCustom), false)] private Vector3 customPos = Vector3.zero;
        [SerializeField, ShowIf(nameof(isCustom)), ShowIf(nameof(shape), GizmosShape.Cube, false)] private Vector3 customSize = new Vector3(1.0f, 1.0f, 1.0f);
        [SerializeField, ShowIf(nameof(isCustom)), ShowIf(nameof(shape), GizmosShape.Sphere, false)] private float customRadius = 1.0f;
